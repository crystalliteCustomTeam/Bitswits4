...
import Building from "/public/newhouston/builingImageNine.png";
...
export default function gamedevelopmentcompany() {
  ...
  // timeline Content
  const timeline = {
    title: "We Follow as a Trustable App Development Company in UK ",
    desc: <>
  ...
  const desc = [
    {
      para: <>Are you planning to invest in mobile app development in UK? Depending on the app’s complexity and functionality, the cost typically ranges between <span>$50,000</span> to  <span>$250,000+</span>.</>
    },
    {
    ...
    {
      para: "If you want to get an estimated cost for your app development project in UK, you can make use of our app development cost calculator. "
    },
  ]
  const delivered = {
    title: "How Much Does it Cost to Make an App in UK ",
    desc: desc,
  }
  // Delivered
  const descBlack = [
  ...
  const compareDesc = [
    ...
    {
      desc: <>
        Also, you can partner with our reputable mobile app development company in UK and get your app developed now for any technology (Native, Hybrid, and Cross-Platform).   </>
    },
  ]
  ...
  const iosdesc = [
    {
      desc: "BitsWits is all about reinventing the app development experience with iOS and all other technologies to outperform the competitive digital market. When it comes to iOS app development in UK, what makes us distinctive is our in-depth knowledge of the iOS platform and our ability to create custom digital apps that perfectly align with your company's goals. Our team of highly skilled iOS developers in UK promises that the products we provide are top-quality and sure to exceed your expectations."
    },
    {
      desc: "We are cognizant of the peculiar challenges inherent in the online world of business and we leverage this awareness in providing you with bespoke iOS app development services that are tailor-made to meet your particular needs. From pre-development to launch, we are 100% involved with you in the app development journey, ensuring your app has the best capabilities that help it stand out in the competitive app market. Get in touch with any professional iOS app developer in UK from BitsWits today and experience the change right away."
    }
  ]
  const IOSContent = {
    title: "Ascend to Greatness with iOS App Development in UK ",
    desc: iosdesc
  }
  // IOS content
  const andrioddesc = [
    {
      desc: "Speaking of Android app development in UK, there is no better app development business to refer to as Bitwsits here. Our top team of certified Android app developers in UK uses tech proficiency and creative thinking to produce superior mobile applications that are noticeable in the very competitive app market. What makes us unique is our dedication to creativity, user experience, and client convenience."
    },
    {
      desc: "Having taken the position of a top Android app development company in UK, we have acquired an understanding of the specific difficulties and benefits of the Android platform. Whether you are developing a new Android application or looking to make your existing Android application better, we are here to help. Our strive for perfection, dedication to our clients, and prioritization of customer satisfaction are the cornerstones of our business."
    },
    {
  ...
  const andriodContent = {
    title: "Take Your Business to Higher Levels by Android App Development in UK ",
    desc: andrioddesc
  }
  ...
  const MobileApplication = {
    title: "BitsWits is More Than an Ordinary Mobile App Development Company UK ",
    desc: MobileApplicationContent
  }
  // conqured content
  const Conquered = {
    title: "Industries We’ve Conquered as an Eminent App Development Company UK ",
    desc: <><span className="d-block">With a strong emphasis on innovation and excellence, BitsWits caters to a diverse range of sectors and industries. Our mobile app development company in UK is committed to transforming your raw ideas into incredible realities. Our app development methodology is combined with innovation and creativity. Plus, we use the latest technologies and tools to deliver exceptional results. </span>
      <br />
  ...
  // Houston UK
  const menus = [
    "App Development Costs According to Business Size In UK",
    "Cost of App Development in UK for a Startup",
    "Cost of App Development in UK for Mid-Sized Businesses",
    "Cost of App Development in UK for Enterprises",
  ];
  const sections = [
    {
      title: "App Development Costs According to Business Size In UK ",
      content: `<p class='fontsfregular'>At BitsWits, we know that the price of making an app depends on your business size and its required features. Our services are tailor made for startups to large enterprises in UK and will fit their budget and needs.</p> `
    },
    {
      title: "Cost of App Development in UK for a Startup",
      content: `<p class='fontsfregular'>Often, start-ups in UK find the cost of app development to be one of the very main components that determines the success or failure of their products. We, at BitsWits, are aware of the exigence which a start-up has to face; which is why we provide competitively priced solutions which will fit in with your budget. We will work together with you to ensure we put together a quality app that satisfies your needs and at the same time fits within your budget. Through the transparent pricing and flexible payment structures we offered, small to medium-size startups have the chance to afford a quality app development. Typically, the cost of building a simple app for a startup from scratch in UK will take between $10,000 and $30,000. This cost includes planning, design, development, testing, and implementation.</p>`
    },
    {
      title: "Cost of App Development in UK for Mid-Sized Businesses",
      content: `<p class='fontsfregular'>Developing apps for small and medium-sized businesses in UK means to have applications that will be able to keep up with the giant competitors without exceeding the set budget. Our cost-effective and time-efficient mid-sized business app development services in UK are purposefully created to help growing start-ups to succeed in business. Along with that, we eliminate the obstacles standing in their way to success. We work in close alignment with you to understand your business needs and tailor-make an app that fits right on budget and gives the perfect solution to your requirements. Through our professional staff and quick development process we can provide enterprise apps to local mid-sized companies in UK at a competitive cost. Mid-sized businesses in UK planning to develop an app can envisage budgets ranging from$30,000 to $100,000.</p>`
    },
    {
      title: "Cost of App Development in UK for Enterprises",
      content: `<p class='fontsfregular'>In UK, the enterprises require applications of the topnotch characteristics and layouts with the advanced functionalities and features. Over at BitsWits, we focus on the creation of enterprise apps that are features-rich and cost friendly for businesses located in the city of UK. Our team of developers will work in close alliance with you to facilitate the process of development of the app that your business is in need of. Our efficient development process back up with transparent pricing feature, allow us to deliver professional-grade apps at reasonable price in UK. And for the larger enterprises in UK, app development might cost somewhere from $100,000 to $500,000.</p>`
    }
  ];
