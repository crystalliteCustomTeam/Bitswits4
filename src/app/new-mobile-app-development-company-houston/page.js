...
import Building from "/public/newhouston/builingImage.png";
...
export default function gamedevelopmentcompany() {
  ...
  // Banner Content
  const Banner = {
    title: "Mobile App Development Company Houston",
    desc: "Bitswits is revolutionizing mobile app development in Houston, driving disruption to elevate the conventional process. Our approach promises a cutting-edge experience, ensuring success for businesses. Leveraging data-driven expertise, we redefine the landscape, delivering ingenious mobile applications to thrive in Houston's lucrative market.",
    pageSlug: "Mobile App Development Company Houston",
  }
  ...
  const Development = {
    title: "Houston App Developers",
    desc: "Bitswits has been a leader in mobile app development in Dubai for over a decade. We have a proven track record of creating product-driven apps that speak for themselves through their high app store ratings and notoriety.",
  ...
  // timeline Content
  const timeline = {
    title: "We Follow as a Trustable App Development Company in Houston ",
    desc: <>
