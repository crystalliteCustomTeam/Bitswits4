...
import Building from "/public/newhouston/builingImageFive.png";
...
export default function gamedevelopmentcompany() {
  ...
  // Banner Content
  const Banner = {
    title: "Mobile App Development Company Austin",
    ...
    pageSlug: "Mobile App Development Company Austin",
  }
  ...
  // timeline Content
  const timeline = {
    title: "We Follow as a Trustable App Development Company in Austin ",
    desc: <>
  ...
  // ClientContent
  const ClientContent = {
    title: <>Why Our Clients <span>Choose Us</span> for Mobile App Development in Austin</>,
