...
import BannerIndustry from '@/src/components/industryPage/BannerIndustry'
import HealthCareServices from '@/src/components/industryPage/healthcareServices'

import ImageOne from "media/industry/cta_img.svg"
import Industrydeveloper from '@/src/components/industryPage/industrydeveloper'
import ExpertiseIndustry from '@/src/components/industryPage/expertise'
import Benefits from '@/src/components/industryPage/Benefits'
...
const page = () => {
    ...
    const smallBannerContent = {
        title: "Innovate Healthcare With Cutting- Edge Apps",
        txt: "We’re a software development company that ensures its expertise extends to offer a seamlessly productive and growth-oriented partnership to its We’re a software development company.",
        img: ImageOne
    }
    // Sample content data
    const menus = [
    ...
    return (
        <>
            ...
            <WhyChoose />
            <DevelopmentProcess />
            <ApplicationOffer content={HoustonContent} bg='yes' />
            <Benefits />
            <Testimonials />
            <YourTech />
            <Fueling />
