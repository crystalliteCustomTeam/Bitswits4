...
const WhyChoose = ({
    ...
    cardData = [
        ...
        ["Expertise of 250+ <br class='d-xl-block d-none' /> Professionals Delivery","We have a team of 250+ skilled 3D game developers with expertise in game engines like Unity, Unreal Engine, Phaser, and Maya."],
