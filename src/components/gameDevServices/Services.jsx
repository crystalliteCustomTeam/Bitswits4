                ...
                <Row>
                    <Col lg={12}>
                        <div className="txt">
                            ...
                            <p className='font16 text-white manrope mb-md-5 pb-3'>We’re a software development company that ensures its expertise extends to offer a seamlessly productive and  <br className='d-xl-block d-none' /> growth-oriented partnership</p>
                        </div>
                    </Col>
                    <Col lg={6}>
